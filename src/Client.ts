...
export class ScoutClient {
     ...
     */
    public sendFollowupEmailsOnboardingFollowupEmailsPost(
        request?: Scout.FollowupEmailRequest,
        requestOptions?: ScoutClient.RequestOptions,
    ): core.HttpResponsePromise<Scout.SrcAppHttpRoutesOnboardingFollowupEmailsResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__sendFollowupEmailsOnboardingFollowupEmailsPost(request, requestOptions),
        );
    }

    private async __sendFollowupEmailsOnboardingFollowupEmailsPost(
        request?: Scout.FollowupEmailRequest,
        requestOptions?: ScoutClient.RequestOptions,
    ): Promise<core.WithRawResponse<Scout.SrcAppHttpRoutesOnboardingFollowupEmailsResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ Authorization: await this._getAuthorizationHeader() }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Scout.SrcAppHttpRoutesOnboardingFollowupEmailsResponse,
                rawResponse: _response.rawResponse,
            };
        }
