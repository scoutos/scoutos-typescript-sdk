    ...
    private async __list(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v2/collections/${core.url.encodePathParam(collection_id)}/tables/${core.url.encodePathParam(table_id)}/documents`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ScoutEnvironment.Prod,
                `v2/collections/${core.url.encodePathParam(collection_id)}/tables/${core.url.encodePathParam(table_id)}/documents/update`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ScoutEnvironment.Prod,
                `v2/collections/${core.url.encodePathParam(collection_id)}/tables/${core.url.encodePathParam(table_id)}/documents/${core.url.encodePathParam(document_id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ScoutEnvironment.Prod,
                `v2/collections/${core.url.encodePathParam(collection_id)}/tables/${core.url.encodePathParam(table_id)}/documents/delete`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
