    ...
    private async __list(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v2/workflows/${core.url.encodePathParam(workflow_id)}/environments`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ScoutEnvironment.Prod,
                `v2/workflows/${core.url.encodePathParam(workflow_id)}/environments/${core.url.encodePathParam(environment_id)}`,
            ),
            method: "PUT",
            headers: _headers,
