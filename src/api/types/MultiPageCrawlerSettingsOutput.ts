...
export interface MultiPageCrawlerSettingsOutput {
    scraper?: MultiPageCrawlerSettingsOutput.Scraper;
    text_extractor?: MultiPageCrawlerSettingsOutput.TextExtractor;
...
export namespace MultiPageCrawlerSettingsOutput {
