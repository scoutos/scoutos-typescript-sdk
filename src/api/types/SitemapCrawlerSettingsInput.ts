...
export interface SitemapCrawlerSettingsInput {
    scraper?: SitemapCrawlerSettingsInput.Scraper;
    text_extractor?: SitemapCrawlerSettingsInput.TextExtractor;
...
export namespace SitemapCrawlerSettingsInput {
