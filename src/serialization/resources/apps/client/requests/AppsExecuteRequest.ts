...
export const AppsExecuteRequest: core.serialization.Schema<
    serializers.AppsExecuteRequest.Raw,
    Scout.AppsExecuteRequest
...
export declare namespace AppsExecuteRequest {
    interface Raw {
