...
import { CollectionViewStateOutputViewsValue } from "./CollectionViewStateOutputViewsValue";

export const CollectionViewStateOutput: core.serialization.ObjectSchema<
    serializers.CollectionViewStateOutput.Raw,
    Scout.CollectionViewStateOutput
> = core.serialization.object({
    views: core.serialization.record(core.serialization.string(), CollectionViewStateOutputViewsValue).optional(),
...
export declare namespace CollectionViewStateOutput {
    export interface Raw {
        views?: Record<string, CollectionViewStateOutputViewsValue.Raw> | null;
