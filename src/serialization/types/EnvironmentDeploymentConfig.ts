...
> = core.serialization.object({
    revisionId: core.serialization.property("revision_id", core.serialization.string().optional()),
    revisionLookup: core.serialization.property("revision_lookup", EnvironmentDeploymentConfigRevisionLookup),
