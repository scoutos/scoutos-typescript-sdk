...
import { SitemapCrawlerSettingsOutputScraper } from "./SitemapCrawlerSettingsOutputScraper";
import { SitemapCrawlerSettingsOutputTextExtractor } from "./SitemapCrawlerSettingsOutputTextExtractor";

export const SitemapCrawlerSettingsOutput: core.serialization.ObjectSchema<
    serializers.SitemapCrawlerSettingsOutput.Raw,
    Scout.SitemapCrawlerSettingsOutput
> = core.serialization.object({
    scraper: SitemapCrawlerSettingsOutputScraper.optional(),
    text_extractor: SitemapCrawlerSettingsOutputTextExtractor.optional(),
