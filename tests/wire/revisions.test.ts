...
describe("Revisions", () => {
    ...
    test("list (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/v2/workflows/workflow_id/revisions")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.revisions.list("workflow_id");
        expect(response).toEqual({
            data: [
                {
                    workflow_config: {},
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.revisions.list("workflow_id");
        }).rejects.toThrow(Scout.UnprocessableEntityError);
    });
    ...
    test("update (1)", async () => {
        ...
        server
            .mockEndpoint()
            .put("/v2/workflows/workflow_id/revisions/revision_id/promote")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.revisions.update("workflow_id", "revision_id");
        expect(response).toEqual({
            data: {
                workflow_config: {
                    workflow_display_name: "workflow_display_name",
